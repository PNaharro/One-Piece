    ...
    while True:
                ...
                if opc_arma == 0:
                    ...
                    while True:
                        ...
                        if opc_acep == "s" or opc_acep == "S":
                            Dicionarios.dict_characters[len(Dicionarios.dict_characters) + 1] = {"name": nombre_ch,
                                                                                                 "category": rank_num,
                                                                                                 "weapons": weapon_num,
                                                                                                 "strength": F,
                                                                                                 "speed": S,
                    ...
                    if opc_arma <= 5:
                        cadena = str(opc_arma) + ") " + Dicionarios.dict_weapons[opc_arma]["name"] + ", strength: " + \
                                 str(Dicionarios.dict_weapons[opc_arma]["strength"]) \
                        ...
                        print(" {} -- {}".format(Fuerza, type(Fuerza)))
                    ...
                    if opc_arma >= 6:
                        cadena = str(opc_arma) + ") " + Dicionarios.dict_weapons[opc_arma]["name"] + \
                                 ", strength: " + str(Dicionarios.dict_weapons[opc_arma]["strength"]) \
                                 + ", speed: " + str(Dicionarios.dict_weapons[opc_arma]["speed"])
                        arma.append(cadena + "\n")
                        weapon.append([Dicionarios.dict_weapons[opc_arma]["name"]])
                        weapon_num.append(opc_arma)
        ...
        if opc == 2:
            ...
            while True:
                opc_acep = input("guarda arma s/n ")
                if opc_acep == "s" or opc_acep == "S":
                    Dicionarios.dict_weapons[len(Dicionarios.dict_weapons) + 1] = {"name": nombre,
