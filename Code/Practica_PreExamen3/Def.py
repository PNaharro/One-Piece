...
import Dicionarios
#####################
for personaje in Dicionarios.dict_characters:
            for j in Dicionarios.dict_characters[personaje]["weapons"]:
                for i in Dicionarios.dict_weapons:
                    if i == j:
                        Dicionarios.dict_characters[personaje]["strength"] += Dicionarios.dict_weapons[i]["strength"]
                        Dicionarios.dict_characters[personaje]["speed"] += Dicionarios.dict_weapons[i]["speed"]
#### def ####
def Inicio(tupla):
    while True:
        cadena = ""
